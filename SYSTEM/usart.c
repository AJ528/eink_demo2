...
//********************************************************************************
//V1.3锟睫革拷说锟斤拷 
//支锟斤拷锟斤拷应锟斤拷同频锟斤拷锟铰的达拷锟节诧拷锟斤拷锟斤拷锟斤拷锟斤拷.
//锟斤拷锟斤拷锟剿讹拷printf锟斤拷支锟斤拷
//锟斤拷锟斤拷锟剿达拷锟节斤拷锟斤拷锟斤拷锟筋功锟斤拷.
//锟斤拷锟斤拷锟斤拷printf锟斤拷一锟斤拷锟街凤拷锟斤拷失锟斤拷bug
//V1.4锟睫革拷说锟斤拷
//1,锟睫改达拷锟节筹拷始锟斤拷IO锟斤拷bug
//2,锟睫革拷锟斤拷USART_RX_STA,使锟矫达拷锟斤拷锟斤拷锟斤拷锟斤拷锟街斤拷锟斤拷为2锟斤拷14锟轿凤拷
//3,锟斤拷锟斤拷锟斤拷USART_REC_LEN,锟斤拷锟节讹拷锟藉串锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷盏锟斤拷纸锟斤拷锟�(锟斤拷锟斤拷锟斤拷2锟斤拷14锟轿凤拷)
//4,锟睫革拷锟斤拷EN_USART1_RX锟斤拷使锟杰凤拷式
//V1.5锟睫革拷说锟斤拷
//1,锟斤拷锟斤拷锟剿讹拷UCOSII锟斤拷支锟斤拷
////////////////////////////////////////////////////////////////////////////////// 	  
	...
	if(USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)  //锟斤拷锟斤拷锟叫讹拷(锟斤拷锟秸碉拷锟斤拷锟斤拷锟捷憋拷锟斤拷锟斤拷0x0d 0x0a锟斤拷尾)
		...
		if((USART_RX_STA&0x8000)==0)//锟斤拷锟斤拷未锟斤拷锟�
			...
			if(USART_RX_STA&0x4000)//锟斤拷锟秸碉拷锟斤拷0x0d
				{
				if(Res!=0x0a)USART_RX_STA=0;//锟斤拷锟秸达拷锟斤拷,锟斤拷锟铰匡拷始
				else USART_RX_STA|=0x8000;	//锟斤拷锟斤拷锟斤拷锟斤拷锟� 
				}
			else //锟斤拷没锟秸碉拷0X0D
				{	
				if(Res==0x0d)USART_RX_STA|=0x4000;
					...
					USART_RX_STA++;
					if(USART_RX_STA>(USART_REC_LEN-1))USART_RX_STA=0;//锟斤拷锟斤拷锟斤拷锟捷达拷锟斤拷,锟斤拷锟铰匡拷始锟斤拷锟斤拷	  
					}		 
				}
			}   		 
     } 
