...
# Cortex-M3 processors do not have a hardware floating point unit
# therefore all float operations are done in software
...
# this prevent gcc from optimizing printf_() if you decide to roll your own
...
LDFLAGS += -T"STM32F10X_HD_FLASH.ld"
